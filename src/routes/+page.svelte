	...
	let mobileMenuItems = $derived.by(() => {
		...
		if (currentUser) {
			items.push({
				...
				icon: faMessage,
				action: () => {
					void goto('/messages?tab=yard-sales');
				},
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
	<AppHeader
		title="Yard Sale Finder"
		subtitle="Discover amazing deals in your neighborhood"
		count={filteredYardSales.length}
		countLabel="found"
		primaryAction={handleCreateYardSale}
		primaryActionLabel="New Yard Sale"
