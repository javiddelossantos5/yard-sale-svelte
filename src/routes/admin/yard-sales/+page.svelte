			...
			<div class="block sm:hidden">
				<div class="flex h-16 items-center justify-between">
					<div class="flex items-center space-x-3">
						...
						/>
						<div>
							<h1 class="text-lg font-semibold text-gray-900 dark:text-white">Manage Yard Sales</h1>
							<p class="text-xs text-gray-500 dark:text-gray-400">{totalYardSales} total</p>
						</div>
					</div>
					<button
			...
			<div class="hidden sm:block">
				<div class="flex h-20 items-center justify-between">
					<div class="flex items-center space-x-4">
						...
						<div>
							<h1 class="text-2xl font-bold text-gray-900 dark:text-white">Manage Yard Sales</h1>
							<p class="text-sm text-gray-600 dark:text-gray-400">
								{totalYardSales} total yard sales • Admin View
							</p>
						</div>
					</div>
