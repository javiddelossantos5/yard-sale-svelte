									...
									{#each yardSale.payment_methods as method}
										{#if method.toLowerCase().includes('venmo') && yardSale.venmo_url}
											<a
												...
												class="inline-flex items-center rounded-full bg-gray-100 px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-blue-100 hover:text-blue-700 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-blue-900 dark:hover:text-blue-300"
